    ...
    <AuthProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/services/teeth-whitening" element={
            <div className="min-h-screen overflow-x-hidden w-full max-w-full">
              <Navbar />
              <Hero />
              <Footer />
          ...
          <Route path="/services/oral-prophylaxis" element={
            <div className="min-h-screen overflow-x-hidden w-full max-w-full">
              <Navbar />
              <OralTop />
              <Footer />
          ...
          <Route path="/services/dental-crowns-and-veneers" element={
            <div className="min-h-screen overflow-x-hidden w-full max-w-full">
              <Navbar />
          ...
          <Route path="/services/tooth-surgery" element={
            <div className="min-h-screen overflow-x-hidden w-full max-w-full">
              <Navbar />
              <ToothTop />
              <Footer />
          ...
          <Route path="/services/flap-surgery" element={
            <div className="min-h-screen overflow-x-hidden w-full max-w-full">
              <Navbar />
              <FlapSurgery />
              <Footer />
          ...
          <Route path="/services/laser-gum" element={
            <div className="min-h-screen overflow-x-hidden w-full max-w-full">
              <Navbar />
              <LaserGum />
              <Footer />
          ...
          <Route path="/services/tooth-extraction" element={
            <div className="min-h-screen overflow-x-hidden w-full max-w-full">
              <Navbar />
              <Tooth_Extra />
              <Footer />
          ...
          <Route path="/services/dental-implants" element={
            <div className="min-h-screen overflow-x-hidden w-full max-w-full">
              <Navbar />
              <Dental_Implents />
              <Footer />
