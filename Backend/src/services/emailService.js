    ...
    try {
      ...
      const mailOptions = {
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                ...
                <p>Thank you for booking an appointment with us! We have received your appointment request and will confirm it shortly.</p>
                ...
                <p><strong>Status:</strong> <span style="color: #FF642F;">Pending Confirmation</span></p>
                <p>Our team will contact you shortly to confirm your appointment. If you have any questions or need to make changes, please don't hesitate to contact us.</p>
        ...
        text: `
          ...
          Thank you for booking an appointment with us! We have received your appointment request.
