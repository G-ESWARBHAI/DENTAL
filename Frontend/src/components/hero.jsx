    ...
    <>
      ...
      >
        ...
        <div className="relative mx-auto px-2 md:px-6 lg:px-12 py-11 md:py-20 lg:py-32 md:min-h-screen flex flex-row items-center">
          ...
          {/* Left Side Content */}
          <motion.div 
            className="max-w-[240px]  lg:max-w-[600px] xl:max-w-2xl ml-2 md:ml-2 lg:ml-2 z-10 relative flex-shrink-0 pr-2 md:pr-4 lg:pr-8"
            variants={containerVariants}
            initial="hidden"
            animate="visible"
          >
            ...
            <motion.h1 
              ...
              variants={titleVariants}
            >
          <h1 className="text-gray-800 font-extrabold leading-tight mt-2 font-sans md:mb-14 md:-mt-2  text-base text-[13px] sm:text-3xl md:text-sm lg:text-[87.47px] font-medium whitespace-nowrap" >
            Every Smile 
         </h1>            
         <h1 className="text-[#0076C0] font-extrabold leading-tight font-sans  sm:mb-3 md:mb-12 text-base text-[13px] sm:text-3xl md:text-sm lg:text-[87.47px] font-medium whitespace-nowrap" >
            Matters          
          </h1>
         </motion.h1>
