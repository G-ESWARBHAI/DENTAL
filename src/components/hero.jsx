  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-white/10"></div>  {/* 10% instead of 20% */}
       ...
       <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between pl-0 md:pl-0 pr-6 md:pr-12 sm:px-8 py-12 md:py-20 min-h-screen">
        
        {/* Left Side Text */}
        <div className="max-w-xl space-y-7 text-left md:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[87.47px] font-medium text-gray-800 leading-tight tracking-wider font-sans">
          ...
          <button className="mt-5 bg-[#FF642F] text-white px-6 sm:px-8 py-3 rounded-full font-semibold flex items-center justify-center gap-3 sm:gap-4 hover:bg-[#ff5a1e] transition font-sans text-sm sm:text-base shadow-md">
              Book Consultation <ArrowRight size={16} className="sm:w-5 sm:h-5" />
            </button>
        </div>
