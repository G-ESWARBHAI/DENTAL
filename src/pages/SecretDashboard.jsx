...
const SecretDashboard = () => {
  ...
  }, [activeTab, statusFilter, page, blogStatusFilter, blogPage])
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const [statsRes, appointmentsRes] = await Promise.all([
        ...
        fetch(`${API_URL}/admin/appointments?status=${statusFilter !== 'all' ? statusFilter : ''}&page=${page}&limit=10&search=${searchTerm}`, {
          credentials: 'include'
        })
      ])
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-yellow-600 mt-2">{stats.statusBreakdown.pending}</p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600 mt-2">{stats.statusBreakdown.confirmed}</p>
                </div>
                          ...
                          <tr key={appointment._id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <select
                                ...
                                className={`text-xs px-2 py-1 rounded-full ${getStatusColor(appointment.status)} border-0 focus:ring-2 focus:ring-[#0067AC]`}
                              >
                                <option value="pending">Pending</option>
                                <option value="confirmed">Confirmed</option>
                                <option value="cancelled">Cancelled</option>
