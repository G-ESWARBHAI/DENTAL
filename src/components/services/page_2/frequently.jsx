...
export default function Frequently() {
  ...
  return (
    <motion.div 
      className="py-6 sm:py-8 md:py-12 lg:py-16 px-4 sm:px-6 md:px-8 bg-white"
      initial="hidden"
      whileInView="visible"
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <div className="flex items-start">
                  ...
                  >
                    <span className="text-gray-700 text-lg sm:text-xl font-bold">+</span>
                  </motion.div>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 leading-relaxed" style={{fontSize: 'clamp(12px, 2vw, 14px)', letterSpacing: '0.3px'}}>
                      {faq.answer}
                    </p>
                  </div>
                </div>
