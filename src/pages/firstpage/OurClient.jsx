      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-10  items-start">
          ...
          <div className="md:col-span-6 flex gap-5">
            {/* Testimonial 1 */}
            <div className="bg-white rounded-lg p-6 relative" style={{width: '310px', height: '280px'}}>
              {/* Opening Quotes */}
              ...
              {/* Testimonial Text */}
              <p className="text-gray-700 mb-4 leading-relaxed" style={{fontSize: '12px', lineHeight: '1.8'}}>
                I had lost a front tooth in an accident, and it really affected my confidence. The team at Sasha Luxe recommended a Nobel Active implant. From day one, they made me feel comfortable and informed. The final crown looks exactly like my natural tooth. I can smile without thinking twice now.
              </p>
            ...
            {/* Testimonial 2 */}
            <div className="bg-white rounded-lg p-6 relative " style={{width: '294px', height: '270px'}}>
              {/* Stars */}
              <div className="mb-4">
                <img src={StarsIcon} alt="5 stars" className="w-auto h-4" />
              </div>
              ...
              {/* Testimonial Text */}
              <p className="text-gray-700 mb-4 leading-relaxed" style={{fontSize: '12px', lineHeight: '1.8'}}>
                I got two Osstem implants at Sasha Luxe, and I honestly forgot they aren't my real teeth. No pain, no hassle—just great service and even better results. Highly recommended!
              </p>
        ...
        <div className="flex  mt-8 ">
          <button className="py-2.5 px-7 rounded-lg font-semibold transition-colors hover:opacity-90" style={{backgroundColor: '#0267AC', fontSize: '17px', color: '#FCC17F'}}>
            Click More
          </button>
        </div>
      </div>
