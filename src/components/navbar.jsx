        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden flex items-center space-x-4">
            <button
              ...
              className="text-dental-dark-blue hover:text-dental-teal transition-colors"
            >
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Q Search here..."
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-dental-teal focus:border-transparent text-sm"
              />
            </div>
          </div>
        )}
