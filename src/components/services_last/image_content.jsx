...
import zoomImage from '../assets/Teeth Whitening/PNG/Zoom Teeth Whitening.png';
import laserImage from '../assets/Teeth Whitening/PNG/Laser Teeth Whitening.png';
import arrowIcon from '../assets/Teeth Whitening/PNG/ARROW.png';
...
const ImageContentSection = () => {
  ...
  return (
    <motion.div 
      className="bg-white py-8 md:py-12 lg:py-16 mt-1"
        ...
        >
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-10 items-start align-top">
            ...
            >
              {/* Sub-heading */}
              <motion.h3 
                className="mb-4 md:mb-2 text-left mt-0"
                style={{ 
                  color: '#0267AC',
                  fontFamily: 'Montserrat, sans-serif',
                  fontWeight: 700,
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Zoom is one of the most trusted whitening systems in the world, and at Sasha Luxe, we tailor it to your exact needs. A special <strong style={{ 
                  fontFamily: 'Montserrat, sans-serif',
                  fontWeight: 700,
                  fontSize: '18.35px',
                  lineHeight: '34.87px',
                  letterSpacing: '0%',
                  color: '#392D44'
                }}>hydrogen peroxide gel</strong> is applied to your teeth and activated with the <strong style={{ 
                  fontFamily: 'Montserrat, sans-serif',
                  fontWeight: 700,
                  fontSize: '18.35px',
                  lineHeight: '34.87px',
              ...
              <motion.h4 
                className="mb-4 md:mb-6 text-left"
                style={{ 
                  color: '#0267AC',
                  fontFamily: 'Montserrat, sans-serif',
                  fontWeight: 700,
        ...
        >
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-10 items-start align-top">
            ...
            >
              {/* Sub-heading */}
              <motion.h3 
                className="mb-4 md:mb-6 text-left mt-0"
                style={{ 
                  color: '#0267AC',
                  fontFamily: 'Montserrat, sans-serif',
                  fontWeight: 700,
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Our Laser Teeth Whitening treatment uses a dental-grade whitening gel, activated by a <strong style={{ 
                  fontFamily: 'Montserrat, sans-serif',
                  fontWeight: 700,
                  fontSize: '18.35px',
                  lineHeight: '34.87px',
                  letterSpacing: '0%',
                  color: '#392D44'
                }}>low-heat laser</strong>, to remove surface and deeper stains. This option is ideal for those with <strong style={{ 
                  fontFamily: 'Montserrat, sans-serif',
                  fontWeight: 700,
                  fontSize: '18.35px',
                  lineHeight: '34.87px',
                  letterSpacing: '0%',
                  color: '#392D44'
                }}>tooth sensitivity</strong> or looking for a more natural brightening.
              </motion.p>
          ...
          >
            ...
            <div className="flex flex-col gap-1 md:gap-6 flex-1">
              {[
                ...
                <motion.div
                  key={index}
                  className="flex items-center p-4 rounded-[16.88px] cursor-pointer hover:shadow-md transition-shadow w-full md:w-[498px]"
                  style={{ 
                    height: '109px',
                    padding: '16px',
                  ...
                  whileHover={{ y: -2 }}
                >
                  <div className="w-8 h-8 rounded-full bg-[#0267AC] flex items-center justify-center mr-3 flex-shrink-0">
                    <img 
                      src={arrowIcon} 
                      alt="arrow" 
                      className="w-4 h-4"
