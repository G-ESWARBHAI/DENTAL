...
export default function Hero() {
  ...
  return (
    <>
        <section 
        className="relative overflow-hidden md:min-h-screen -mt-5 lg:-mt-7 "
        style={{
      ...
      >
        ...
        <div className="relative mx-auto px-2 md:px-6 lg:px-12 py-11 md:py-20 lg:py-32 md:min-h-screen flex flex-row items-center">
          ...
          >
            {/* Main Title */}
            <motion.h1 
              className="font-bold text-[#0267AC] leading-tight mb-1 lg:mb-7 tracking-tight text-[19px] sm:text-base md:text-2xl lg:text-[56px]"
